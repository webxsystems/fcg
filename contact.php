...
<head>
    <title>First Capital Gold | Contact </title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="heading-title iq-mb-25">
                        <h3 class="title text-uppercase iq-font-white iq-tw-6">Contact <span style="color:#f9b707;font-weight:100;">First Capital Gold</span></h3>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="iq-contact-box-01">
                            ...
                            <div class="contact-content">
                                ...
                                <span class="lead iq-tw-6">2831 Saint Rose Parkway, Henderson, NV 89052</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="iq-contact-box-01">
                            ...
                            <div class="contact-content">
                                ...
                                <span class="lead iq-tw-6"> (833)-246-5387</span>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="iq-contact-box-01">
                            ...
                            <div class="contact-content">
                                ...
                                <span class="lead iq-tw-6">sales@firstcapitalgold.com</span>
